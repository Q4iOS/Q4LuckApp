...
@implementation SDZScheduleInfo
	@synthesize AllowSelfTicket = _AllowSelfTicket;
	...
	- (id) initWithNode: (CXMLNode*) node {
		...
		{
			self.AllowSelfTicket = [[Soap getNodeValue: node withName: @"AllowSelfTicket"] boolValue];
	...
	- (NSMutableString*) serializeElements
	{
		...
		[s appendFormat: @"<AllowSelfTicket>%@</AllowSelfTicket>", (self.AllowSelfTicket)?@"true":@"false"];
