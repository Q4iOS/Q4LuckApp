...
@implementation SDZTickets
	...
	{
		return [self TicketAssignment: handler action: nil deviceid: deviceid udid: udid timestamp: timestamp latitude: latitude longitude: longitude locationcode: locationcode productid: productid orderid: orderid customername: customername amount: amount type: type];
	}

	- (SoapRequest*) TicketAssignment: (id) _target action: (SEL) _action deviceid: (NSString*) deviceid udid: (NSString*) udid timestamp: (NSDate*) timestamp latitude: (NSString*) latitude longitude: (NSString*) longitude locationcode: (int) locationcode productid: (NSString*) productid orderid: (NSString*) orderid customername: (NSString*) customername amount: (NSDecimalNumber*) amount type: (NSString*) type
		{
		NSMutableArray* _params = [NSMutableArray array];
		...
		[_params addObject: [[[SoapParameter alloc] initWithValue: latitude forName: @"latitude"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: longitude forName: @"longitude"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: [NSNumber numberWithInt: locationcode] forName: @"locationcode"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: productid forName: @"productid"] autorelease]];
		...
		[_params addObject: [[[SoapParameter alloc] initWithValue: amount forName: @"amount"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: type forName: @"type"] autorelease]];
		NSString* _envelope = [Soap createEnvelope: @"TicketAssignment" forNamespace: self.namespace withParameters: _params withHeaders: self.headers];
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://tempuri.org/ITickets/TicketAssignment" postData: _envelope deserializeTo: [[SDZTicketResponse alloc] autorelease]];
		[_request send];
		return _request;
	}
